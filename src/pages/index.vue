<template>
  <div class="dark:text-slate-400 dark:bg-slate-900">
    <Header />
    <main class="max-w-5xlc:\Users\ahh\Downloads\logo1.svg px-4 mx-auto pb-22 sm:px-6 md:px-8 xl:px-12 xl:max-w-6xl">
      <div class="pt-8 pb-7 sm:pb-8 sm:text-center">
        ...
        <p class="text-2xl text-slate-800 dark:text-slate-400">Vue3 + Vite4.x + TypeScript + Pinia + ...</p>
      </div>
    </main>
