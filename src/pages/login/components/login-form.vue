<template>
  <div class="login-form-wrapper">
    ...
    <div class="login-form-sub-title">Vue3+Vite+...模板</div>
    ...
    <el-form ref="ruleFormRef" :model="userFormData" class="login-form" layout="vertical" :rules="rules">
      <el-form-item
        ...
        hide-label
      >
        <el-input v-model="userFormData.username" placeholder="123456" />
      </el-form-item>
      <el-form-item
        prop="password"
        ...
        hide-label
      >
        <el-input v-model="userFormData.password" placeholder="密码：123456" allow-clear />
      </el-form-item>
